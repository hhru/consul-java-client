...
public class AclTestIgnore {
    ...
    protected static Address aclClientHostAndPort = new Address(consulContainerAcl.getHost(), consulContainerAcl.getFirstMappedPort());

    @BeforeClass
    public static void beforeClass() {
        client = Consul.builder()
            .withAddress(aclClientHostAndPort)
    ...
    public void testCreateAndReadToken() {
        ...
        TokenResponse createdToken = aclClient.createToken(ImmutableToken.builder()
            .description(tokenDescription).local(false)
