...
public abstract class Role {
    ...
    @JsonDeserialize(as = List.class, contentAs = RolePolicyLink.class)
    public abstract List<RolePolicyLink> policies();

    @JsonProperty("ServiceIdentities")
    @JsonDeserialize(as = List.class, contentAs = RoleServiceIdentity.class)
    public abstract List<RoleServiceIdentity> serviceIdentities();

    @JsonProperty("NodeIdentities")
    @JsonDeserialize(as = List.class, contentAs = RoleNodeIdentity.class)
